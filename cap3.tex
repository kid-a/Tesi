...
\end{lstlisting}
%
Il \texttt{file\_poller}, %% genera dei report
...
%% %% process offsets, e.g. energy offset for the power transponder
%% Vars = process_offsets (Plant, DeviceID, ScaledVars),
%% %% write variables into the local cache   
%% plant_status:batch_write_variables (Plant, DateTime, DeviceID, Vars),

\section{Web Services}
%% due parole sui web services
