...
l'unico punto di accesso al tale database. 
%
...
sono stati automaticamente generati i record elencati nel listato \ref{code:database-record}.
%
...
\texttt{data\_storage}, il quale implementa un server, sfruttando il behaviour OTP 
\emph{gen\_server}\cite{gen-server}.
%
